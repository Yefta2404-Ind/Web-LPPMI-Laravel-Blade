...
<div class="dashboard-container">
    ...
    <div class="content-grid">
        ...
        <div class="content-card">
            <div class="card-header">
                <h3><i class="fas fa-poll"></i> Survey Saya</h3>
                <div class="card-actions">
            ...
            <div class="card-content">
                @if($mySurveys->count())
                    <div class="items-list">
                        @foreach($mySurveys->take(4) as $survey)
                            <div class="list-item">
                                <div class="item-header">
                                    <div class="item-title text-truncate">{{ $survey->title }}</div>
                                ...
                                <div class="item-actions">
                                    <a href="{{ $survey->survey_url }}" target="_blank" class="btn btn-outline btn-sm">
                                        <i class="fas fa-link"></i> Google Form
                                    </a>
                                </div>
                            </div>
                        @endforeach
                ...
                @else
                    <div class="empty-state">
                        ...
                        <div class="text">Belum ada survey</div>
                        <a href="{{ route('staff.surveys.create') }}" class="btn btn-primary btn-sm">
                            <i class="fas fa-plus"></i> Buat Survey
                        </a>
                    </div>
                @endif
            </div>
        ...
        <div class="content-card">
            <div class="card-header">
                <h3><i class="fas fa-video"></i> Video Saya</h3>
                <div class="card-actions">
                    <a href="{{ route('staff.videos.create') }}" class="btn btn-primary btn-sm">
                        <i class="fas fa-plus"></i> Baru
                    </a>
                </div>
            </div>
            ...
            <div class="card-content">
                @if($myVideos->count())
                    <div class="items-list">
                        @foreach($myVideos->take(4) as $video)
                            <div class="list-item">
                                <div class="item-header">
                                    <div class="item-title text-truncate">{{ $video->title }}</div>
                                ...
                                <div class="item-actions">
                                    <a href="{{ route('staff.videos.edit', $video->id) }}" class="btn btn-secondary btn-sm">
                                        <i class="fas fa-edit"></i> Edit
                                    </a>
                                </div>
                            </div>
                ...
                @else
                    <div class="empty-state">
                        ...
                        <div class="text">Belum ada video</div>
                        <a href="{{ route('staff.videos.create') }}" class="btn btn-primary btn-sm">
